...
class TableFooterView: UIView {
    ...
    let footerTextView : UITextView = {
        ...
        textView.textColor = UIColor(red: 152.0 / 255.0, green: 153.0 / 255.0, blue: 154.0 / 255.0, alpha: 1.0)
    ...
    let instaButton : UIButton = {
        let btn = UIButton()
        btn.setImage(UIImage(named: "btnInsta"), for: .normal)
        return btn
    }()
    
    let facebookButton : UIButton = {
        let btn = UIButton()
        btn.setImage(UIImage(named: "btnFacebook"), for: .normal)
        return btn
    }()
    ...
    let naverButton : UIButton = {
        let btn = UIButton()
        btn.setImage(UIImage(named: "btnNaver"), for: .normal)
        return btn
    }()
    
    let youtubeButton : UIButton = {
        let btn = UIButton()
        btn.setImage(UIImage(named: "btnYoutube"), for: .normal)
        return btn
    }()
    ...
    override init(frame: CGRect) {
        ...
        addSubviews(introButton, termButton, privacyButton, footerTextView, footerImage, footerLabel, snsStackView)
